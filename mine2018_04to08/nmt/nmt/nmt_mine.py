...
'''
tenforflowのニューラル機械翻訳(seq2seq形式のencoder-decoderモデル)チュートリアルを一部書き換えたやつ


主な変更箇所

srcやtgtが関連するところを自分の入出力ファイルへ
...
def extend_hparams(hparams):
  ...
  if hparams.vocab_prefix:
    src_vocab_file = hparams.vocab_prefix + "_" + hparams.src + ".txt"
    tgt_vocab_file = hparams.vocab_prefix + "_" + hparams.tgt + ".txt"
  else:
  ...
  if hparams.embed_prefix:
    src_embed_file = hparams.embed_prefix + "_" + hparams.src + ".txt"
    tgt_embed_file = hparams.embed_prefix + "_" + hparams.tgt + ".txt"
